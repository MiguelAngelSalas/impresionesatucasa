...
const ResumenCarrito = ({ carrito, removeFromCart, totalPaginas, totalSinDescuento, descuento, totalConDescuento }) => {
  return (
            ...
            {carrito.map((item) => (
              ...
              >
                <div>
                  ...
                  <span className="text-sm text-gray-600">📄 {item.detalles.paginas} hoja{item.detalles.paginas > 1 ? "s" : ""}</span>
                </div>
                <button
